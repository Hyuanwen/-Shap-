...
#ifndef __ESRISPATIALANALYST_OLB__
#define __ESRISPATIALANALYST_OLB__
...
#include "tlh/esrispatialanalyst.tlh"
...
#include "esricarto.h"
#include "esrigeoprocessing.h"
#import "esrispatialanalyst.olb" raw_interfaces_only raw_native_types no_namespace named_guids exclude( "OLE_HANDLE", "OLE_COLOR", "UINT_PTR" )

#endif /* ESRI_UNIX,ESRI_WINDOWS */

#endif /* __ESRISPATIALANALYST_OLB__ */
