...
LRESULT CTextProgressCtrl::OnSetText(WPARAM, LPARAM _param)
{
	LPCTSTR szText=(LPCTSTR)_param;
...
LRESULT CTextProgressCtrl::OnGetText(WPARAM _wparam, LPARAM _param)
{
	LPCTSTR szText=(LPCTSTR)_param;
	UINT cchTextMax=(UINT) _wparam;
	//debug_df
    if (!/*_tcsncpy*/strcpy((LPSTR)szText, (LPCSTR)m_strText.GetString()))
        return 0;
    else 
