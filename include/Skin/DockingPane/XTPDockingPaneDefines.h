...
enum XTPDockingPanePaintTheme
{
	...
	xtpPaneThemeWord2007,           // Word 2007 theme
	xtpPaneThemeOutlook2007,        // Outlook 2007 theme
...
enum XTPDockingPaneOptions
{
	...
	xtpPaneNoFloatableByTabDoubleClick = 64,
	xtpPaneNoFloatableByCaptionDoubleClick = 128
};
