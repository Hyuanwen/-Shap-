...
enum XTPTabColorStyle
{
	...
	xtpTabColorVisualStudio2008 = 64, // Tabs will use the Visual Studio 2008 color style for the currently set Appearance.
	xtpTabColorAccess2007 = 128
};
...
public:
	...
	protected:
		...
		//===========================================================================
	// Summary:
	//     CColorSetAccess2007 is a CColorSetOffice2007 derived class that represents the
	//     Office 2007 tab color set.
	//===========================================================================
	class _XTP_EXT_CLASS CColorSetAccess2007 : public CColorSetOffice2007
	{
	public:
		//-------------------------------------------------------------------------
		// Summary:
...
//}}AFX_CODEJOCK_PRIVATE
	...
	public:
		...
		//-----------------------------------------------------------------------
		virtual int GetSupportedColorSets() { return xtpTabColorDefault | xtpTabColorVisualStudio | xtpTabColorOffice2003 | xtpTabColorWinXP | xtpTabColorWhidbey | xtpTabColorVisualStudio2008; }
