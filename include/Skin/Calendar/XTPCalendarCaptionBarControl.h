...
public:
	...
	virtual BOOL IsExpandButton();      // <COMBINE IsSwitchViewButtons>
	...
	virtual void SetExpandButton(BOOL bVisible);        // <COMBINE SetSwitchViewButtons>
