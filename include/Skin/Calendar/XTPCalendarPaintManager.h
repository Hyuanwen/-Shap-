...
public:
	...
	//          Time Line view
	//-----------------------------------------------------------------------
/*  BEGIN_VIEW_PART(TimeLineViewTimeScalePart, XTPCalendarViewPart)
		CXTPCalendarViewPartFontValue m_fntUpperScaleText; // Upper time scale header text font.
		...
		//virtual int CalcEventHeigt(CDC* pDC);
		//virtual void DrawEvent(CDC* pDC, const CRect& rcEvents, CXTPCalendarTimeLineViewEvent* pEventView);

		virtual int _CalcHeaderHeigt(CDC* pDC);
		virtual int _CalcScaleHeigt(CDC* pDC);

		virtual void DrawUpperScale(CDC* pDC, const CRect& rc,
									CXTPCalendarTimeLineViewTimeScale* pTimeScale);

		virtual void DrawLowerScale(CDC* pDC, const CRect& rc,
									CXTPCalendarTimeLineViewTimeScale* pTimeScale){};
	END_VIEW_PART(TimeLineViewTimeScalePart)
*/
	BEGIN_VIEW_PART(TimeLineViewTimeScalePart_Day, XTPCalendarTimeLineViewTimeScalePart)
		//virtual int CalcLowerScaleHeigt(CDC* pDC);
	...
	BEGIN_VIEW_PART(TimeLineViewPart, XTPCalendarTimeLineViewPart)
		...
		CXTPPaintManagerColor m_clrEventBar;
		CXTPPaintManagerColor m_clrEventBarLine;

		CXTPPaintManagerColor m_clrSelectedBackground;
		...
		//virtual int CalcEventHeigt(CDC* pDC){return 26;};
		...
		virtual void RefreshMetrics();
		//CBitmap  m_bmpEvent;
		CXTPOffice2007Image* m_pimgEvent;
