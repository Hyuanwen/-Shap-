...
public:
	...
	//          x - Specifies the logical x-coordinate of the upper-left
	//              corner of the rectangle.
	//          y - Specifies the logical y-coordinate of the upper-left
	//              corner of the destination rectangle.
	//          cx - Specifies the width of the rectangle.
	//          cy - Specifies the height of the rectangle.
	//          bExpanded - TRUE if expanded gripper.
	// Summary: This method is called to draw popup bar right gripper.
	//-----------------------------------------------------------------------
	virtual void DrawPopupBarGripper(CDC* pDC, int x, int y, int cx, int cy, BOOL bExpanded);

	//-----------------------------------------------------------------------
	// Input:   DC         - Pointer to a valid device context
	//          rc          - Rectangle to draw.
	//          bSelected   - TRUE if the control is selected.
	//          bPressed    - TRUE if the control is pushed.
	//          bEnabled    - TRUE if the control is enabled.
...
protected:
	...
	//-----------------------------------------------------------------------
	// Summary: Draws pixel in specific position with specifi Alpha.
	...
	//-----------------------------------------------------------------------
	void AlpaPixel(CDC* pDC, int x, int y, COLORREF clr, int nAlpha);
