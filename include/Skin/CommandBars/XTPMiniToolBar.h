...
public:
	...
	//-----------------------------------------------------------------------
	// Summary: Call this method to create CXTPMiniToolBar class
	// Input:   pCommandBars - Pointer to owner CXTPCommandBars
...
protected:
	...
	//-------------------------------------------------------------------------
	// Summary: UpdateLayeredWindow declaration
	//-------------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------
	// Summary: SetLayeredWindowAttributes declaration
	//-------------------------------------------------------------------------
