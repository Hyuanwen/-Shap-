...
// Remarks:
//     Call CXTPReportControl::SetRecordsTreeFilterMode to set options for Fitlering tree
// Example:
...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Returns selected filter mode for record tree
	...
	// Parameters:
	//     nMode - XTPReportFilterMode enumerator.
	// See Also: GetRecordsTreeFilterMode, XTPReportFilterMode
	//-----------------------------------------------------------------------
	void SetRecordsTreeFilterMode(int nMode); // enum XTPReportFilterMode
	...
	// Parameters:
	//      nStep - Vertical scrolling timer resolution in milliseconds.
	// See also:
	//      CWnd::SetTimer
	//-----------------------------------------------------------------------
...
AFX_INLINE void CXTPReportControl::SetFreezeColumnsCount(int nCount) {
	...
	if(m_bFullColumnScrolling)
		SetFullColumnScrolling(m_bFullColumnScrolling);
}
