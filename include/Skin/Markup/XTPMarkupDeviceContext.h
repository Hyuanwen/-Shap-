...
public:
	virtual void Ellipse(CRect rc, int nStroke, CXTPMarkupBrush* pStrokeBrush, CXTPMarkupBrush* pFillBrush);
	...
	virtual void DrawLine(int x1, int y1, int x2, int y2, int nStroke, CXTPMarkupBrush* pStrokeBrush);
	virtual void Polyline(const POINT* points, int nCount, int nStroke, CXTPMarkupBrush* pStrokeBrush);
	virtual void Polygon(const POINT* points, int nCount, int nStroke, CXTPMarkupBrush* pStrokeBrush, CXTPMarkupBrush* pFillBrush);
	virtual void DrawPath(CXTPMarkupPathGeometry* pGeometry, int nStroke, CXTPMarkupBrush* pStrokeBrush, CXTPMarkupBrush* pFillBrush);
...
public:
	...
	GpGraphics* GetGraphics();
	void ReleaseGraphics(GpGraphics* pGpGraphics);

protected:
	GpBrush* CreateGpBrush(CXTPMarkupBrush* pBrush, LPCRECT lpRect) const;
	GpPen* CreateGpPen(int nStroke, CXTPMarkupBrush* pBrush, LPCRECT lpRect) const;
