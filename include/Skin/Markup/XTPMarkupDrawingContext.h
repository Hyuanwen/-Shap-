...
{
public:
	CXTPMarkupDrawingContext(HDC hDC, HDC hAttribDC = 0);
...
public:
	void Ellipse(CRect rc, int nStroke, CXTPMarkupBrush* pStrokeBrush, CXTPMarkupBrush* pFillBrush);
	...
	void DrawLine(int x1, int y1, int x2, int y2, int nStroke, CXTPMarkupBrush* pStrokeBrush);
	void Polyline(const POINT* points, int nCount, int nStroke, CXTPMarkupBrush* pStrokeBrush);
	void Polygon(const POINT* points, int nCount, int nStroke, CXTPMarkupBrush* pStrokeBrush, CXTPMarkupBrush* pFillBrush);

	void DrawPath(CXTPMarkupPathGeometry* pGeometry, int nStroke, CXTPMarkupBrush* pStrokeBrush, CXTPMarkupBrush* pFillBrush);
