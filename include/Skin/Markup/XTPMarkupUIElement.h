...
public:
	...
	// Summary: Detacts if a point belongs to this object.
...
protected:
	...
	CRect m_rcFinalRect;
	BOOL m_bMeasureDirty;
	BOOL m_bNeverMeasured;
	CSize m_szPreviousAvailableSize;
	BOOL m_bArrangeDirty;
	BOOL m_bNeverArranged;
	BOOL m_bArrangeInProgress;
	BOOL m_bMeasureInProgress;
