...
//{{AFX_CODEJOCK_PRIVATE
		...
		case xtThemeOffice2000:  return GetXtremeColor(bTopLeft? COLOR_3DSHADOW: COLOR_3DHIGHLIGHT);
		case xtThemeOffice2003:  return GetXtremeColor(XPCOLOR_FRAME);
		case xtThemeNativeWinXP: return GetXtremeColor(XPCOLOR_STATICFRAME);
