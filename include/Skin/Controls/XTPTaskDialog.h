...
public:
	...
	// Remarks:
	//       Call AddInputBox to add user input box for task dialg.
	// See Also:
	...
	void SetCommonButtons(BOOL bOk, BOOL bYes, BOOL bNo, BOOL bCancel, BOOL bRetry, BOOL bClose);  //<COMBINE CXTPTaskDialog::SetCommonButtonsn@TASKDIALOG_COMMON_BUTTON_FLAGS>
...
AFX_INLINE void CXTPTaskDialog::SetInputBoxText(LPCTSTR lpszInputBoxText) {
	m_strInputBoxText = lpszInputBoxText;
}
AFX_INLINE CString CXTPTaskDialog::GetInputBoxText() const {
