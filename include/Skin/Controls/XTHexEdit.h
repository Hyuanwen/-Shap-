...
public:
	...
	virtual BOOL Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext = NULL);// <combine CXTHexEdit::Create@DWORD@RECT&@CWnd*@UINT>
...
public:
	...
	//-----------------------------------------------------------------------
	CSize GetSel();
	void GetSel(int& nSelStart, int& nSelEnd); // <combine CXTHexEdit::GetSel>
