...
//===========================================================================
// Summary:
//     CXTColorSelectorCtrlThemeOffice2007 is derived from CXTColorSelectorCtrlThemeOfficeXP to
//     handle theme specific visualizations for the CXTColorSelectorCtrl
//     class.
//===========================================================================
class _XTP_EXT_CLASS CXTColorSelectorCtrlThemeOffice2007 : public CXTColorSelectorCtrlThemeOfficeXP
{
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTColorSelectorCtrlThemeOffice2007 object.
	//-----------------------------------------------------------------------
	CXTColorSelectorCtrlThemeOffice2007();
...
const DWORD CPS_XT_RIGHTALIGN      = 0x0040;  //<ALIAS CXTColorSelectorCtrl::Create@CRect@CWnd*@DWORD@COLORREF@COLORREF>
