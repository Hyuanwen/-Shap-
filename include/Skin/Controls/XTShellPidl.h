...
public:
	//=======================================================================
	// Summary:
	//     CXTShellPidl::CShellMalloc is a helper class that is used by
	//     CXTShellPidl to initialize a pointer to the Shell's IMalloc
	...
	public:
		//-------------------------------------------------------------------
		// Summary:
		//     Constructs a CXTShellPidl::CShellMalloc object and initializes
		...
		//-------------------------------------------------------------------
		// Summary:
		//     Destroys a CXTShellPidl::CShellMalloc object, handles cleanup
		//     and deallocation
		//-------------------------------------------------------------------
	...
	//=======================================================================
	// Summary:
	//     CXTShellPidl::CShellSpecialFolder is a helper class that is used by
	//     CXTShellPidl to initialize a pointer to an IDTEMIDLIST structure of
	//     a special folder.
	//=======================================================================
	...
	public:
		//-------------------------------------------------------------------
		// Summary:
		//     Constructs a CXTShellPidl::CShellSpecialFolder object and
		...
		//-------------------------------------------------------------------
		// Summary:
		//     Destroys a CXTShellPidl::CShellSpecialFolder object, handles
	...
	//     lpsf  - Pointer to the parent shell folder.
	//     lpi   - Fully qualified item ID list for the current item.
	//     uMask - Single ULONG value contains the attributes that the caller is requesting.
	// Returns:
