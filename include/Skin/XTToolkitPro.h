...
//#endif
	...
	//#pragma comment(lib, "DeuSkinV9" _XTPLIB_PROJECT_EVAL _XTPLIB_FILE_VERSION _XTPLIB_VISUALSTUDIO_VERSION _XTPLIB_PLATFORM _XTPLIB_PROJECT_CONFIGURATION ".lib")
#pragma comment(lib, "DeuSkinV9" _XTPLIB_PROJECT_CONFIGURATION ".lib")
	//#pragma message("DeuSkin" _XTPLIB_PROJECT_EVAL _XTPLIB_FILE_VERSION _XTPLIB_VISUALSTUDIO_VERSION _XTPLIB_PLATFORM _XTPLIB_PROJECT_CONFIGURATION "." _XTPLIB_LINK_TYPE)
	#pragma message("DeuSkinV9" _XTPLIB_PROJECT_CONFIGURATION "." _XTPLIB_LINK_TYPE)
