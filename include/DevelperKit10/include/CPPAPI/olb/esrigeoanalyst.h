...
#ifndef __ESRIGEOANALYST_OLB__
#define __ESRIGEOANALYST_OLB__
...
#include "esricarto.h"
#include "tlh/esrigeoanalyst.tlh"
...
#include "esrioutput.h"
#include "esricarto.h"
#import "esrigeoanalyst.olb" raw_interfaces_only raw_native_types no_namespace named_guids exclude( "OLE_HANDLE", "OLE_COLOR", "UINT_PTR" )

#endif /* ESRI_UNIX,ESRI_WINDOWS */

#endif /* __ESRIGEOANALYST_OLB__ */
