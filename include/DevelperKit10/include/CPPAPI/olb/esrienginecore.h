...
#ifndef __ESRIENGINECORE_OLB__
#define __ESRIENGINECORE_OLB__
...
#include "tlh/esrienginecore.tlh"
...
#include "esriglobecore.h"
#include "esri3danalyst.h"
#import "esrienginecore.olb" raw_interfaces_only raw_native_types no_namespace named_guids exclude( "OLE_HANDLE", "OLE_COLOR", "UINT_PTR" )

#endif /* ESRI_UNIX,ESRI_WINDOWS */

#endif /* __ESRIENGINECORE_OLB__ */
