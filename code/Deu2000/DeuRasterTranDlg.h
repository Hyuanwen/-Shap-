...
class CDeuRasterTranDlg : public CDialog
{
	DECLARE_DYNCREATE(CDeuRasterTranDlg)

public:
	CDeuRasterTranDlg();           // 动态创建所使用的受保护的构造函数
	virtual ~CDeuRasterTranDlg();
...
public:
	...
	vector<STR_SDEINFO>		m_vecSelect;			//选择要转换的数据集合
};
