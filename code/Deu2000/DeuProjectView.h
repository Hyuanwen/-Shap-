...
class CDeuProjectView : public CView
{
	DECLARE_DYNCREATE(CDeuProjectView)

protected:
	CDeuProjectView();           // 动态创建所使用的受保护的构造函数
	virtual ~CDeuProjectView();

public:
	CDeuProjectDoc* GetDocument() const;
